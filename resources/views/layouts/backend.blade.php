...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>CommunityApplication</title>

        <meta name="description" content="CommunityApplication">
        <meta name="author" content="prakash gujarati">
                    ...
                    <div class="content-header bg-white-10">
                        ...
                        <a class="font-w600 text-white tracking-wide" href="/">
                            <span class="smini-visible">
                                C<span class="opacity-75">A</span>
                            </span>
                            <span class="smini-hidden">
                                Community<span class="opacity-75">Application</span>
                            </span>
                        </a>
                        <!-- END Logo -->
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-right">
                            Crafted with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="https://gujaratigraphics.com" target="_blank">GujaratiGraphics</a>
                        </div>
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                            <a class="font-w600" href="#" target="_blank">CommunityApplication</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
