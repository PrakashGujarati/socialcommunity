                ...
                <table class="table table-responsive table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                @if($news->thumbnail)
                                    <img class="border rounded" src="{{asset('news_thumbnails/'.json_decode($news->thumbnail)[0])}}" height="60">
                                @else
                            ...
                            <td>
                                @if($news->news_image)
                                    <img class="border rounded" src="{{asset('news_images/'.json_decode($news->news_image)[0])}}" height="60">
                                @else
                                    <img class="border rounded" src="https://donatepoints.aircanada.com/img/no_image_available.jpg" height="60">
                                @endif
                            </td>
