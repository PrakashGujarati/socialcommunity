                ...
                <table class="table table-responsive table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                            @if($employee->logo)
                                <img class="border rounded" src="{{asset('employee_logos/'.$employee->logo)}}" height="60">
                            @else
                            ...
                            <td>
                                <div class="d-flex">
                                    <button type="button" class="btn btn-default mx-2" data-toggle="modal" data-target="#Modal-{{$employee->id}}">
                                        <i class="bi bi-aspect-ratio"></i>
                                    </button>
                                    <a href="{{route('employee.edit',$employee)}}" class="btn btn-default mx-2">
                                    ...
                                    <form action="{{route('changeStatus','employee')}}" method="post">
                                        @csrf
